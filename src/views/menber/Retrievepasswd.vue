        ...
        <div class="show_loading" ref="show_loading">
            <div class="form-wrap">
                ...
                <mu-form ref="captcha_form" :model="form_data">
                    ...
                    <mu-form-item label="新密码" prop="login_pwd" :rules="login_pwdRules">
            ...
            <div class="but-box">
                <mu-button class="operating-item" full-width color="primary" large @click="post_forgetPwd">修改密码</mu-button>
            </div>
        </div>
...
<script>
    ...
    import {forgetPwd} from "@/api/loginRegister.js";
                    ...
                    this.$refs.captcha_form.validate().then((result_tow) => {
                        if (result_one && result_tow) {
                            ...
                            const params = {
                                ...
                                new_pwd: this.form_data.login_pwd,
                            };
